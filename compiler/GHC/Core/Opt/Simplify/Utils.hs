...
--
-- Re the 'floats' argument see Note [Eta reduction with floats]
--
  ...
  where
    ...
    mkLam' dflags bndrs body
      ...
      , etaFloatOk bndrs floats  -- Can the floats go outside the lambdas?
          -- Do this last because it is relatively expensive, since we take the
          -- free-vars of the floats.  See Note [Eta reduction with floats]
...
Note [Eta reduction with floats]
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Consider this:
